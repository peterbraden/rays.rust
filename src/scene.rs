...
impl Scene {
    pub fn demo () -> Scene {
        ...
        let c = camera::Camera::new(
            Vector3::new(0f64,2f64,0f64), //lookat
            Vector3::new(10f64,10f64,-15f64), // loc
        ...
        let s1 = Sphere::new(Vector3::new(0f64, 2f64, 0f64), 1f64);
        let s2 = Sphere::new(Vector3::new(3f64, 1f64, -1f64), 0.5f64);
        let s3 = Sphere::new(Vector3::new(-3f64, 1f64, 1f64), 0.5f64);
