...
pub struct CheckeredYPlane {
    pub m1: Box<MaterialModel + Sync + Send>,
    pub m2: Box<MaterialModel + Sync + Send>,
    pub xsize: f64,
    pub zsize: f64,
}
impl CheckeredYPlane {
    pub fn new(m1: Box<MaterialModel + Sync + Send>, m2: Box<MaterialModel + Sync + Send>, xsize: f64, zsize: f64) -> CheckeredYPlane {
